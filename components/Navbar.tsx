...
export const Navbar = () => {
  return (
    <header className="flex item-center justify-between shadow-sm shadow-gray-200 dark:shadow-none dark:bg-[#020817] bg-gradient-to-br from-purple-100 to-indigo-200 z-20">
